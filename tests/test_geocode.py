...
from ai_research.geo.geocode import parse_response
from ai_research.geo.geocode import place_by_id
from ai_research.geo.geocode import place_by_name
...
@mock.patch("ai_research.geo.geocode.requests.get", autospec=True)
